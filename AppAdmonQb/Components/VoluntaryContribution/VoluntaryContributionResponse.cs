...
{
    internal class VoluntaryContributionResponse
    {
        ...
        public VoluntaryContributionResponse(IMsgSetResponse ResponseMsgSet, dynamic deposits)
        {
            responseMsgSet = ResponseMsgSet;
            depositList = deposits;
        }

        public VoluntaryContributionResponse Walk()
        {
